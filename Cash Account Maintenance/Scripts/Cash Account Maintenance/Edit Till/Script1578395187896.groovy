...
WebUI.click(findTestObject('Object Repository/Edit Till/Page_icon-app/a_Edit Till'))

not_run: WebUI.click(findTestObject('Object Repository/Edit Till/Page_icon-app/svg'))
