...
WebUI.click(findTestObject('Object Repository/Assign Till/Page_icon-app/span_Cash Account Maintenance'))

WebUI.setText(findTestObject('Object Repository/Assign Till/Page_icon-app/input_ADD TILL_ant-input'), 'cam009')
...
WebUI.click(findTestObject('Object Repository/Assign Till/Page_icon-app/a_Assign'))

WebUI.click(findTestObject('Object Repository/Assign Till/Page_icon-app/div_'))
