...
WebUI.click(findTestObject('Assign Till/Page_icon-app/a_Assign'))

WebUI.click(findTestObject('Assign Till/Page_icon-app/div_'))

WebUI.click(findTestObject('Assign Till/Page_icon-app/li_LBT5001'))

WebUI.click(findTestObject('Assign Till/Page_icon-app/button_ASSIGN TILL'))
