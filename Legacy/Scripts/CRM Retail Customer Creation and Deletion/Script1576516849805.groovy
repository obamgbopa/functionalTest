...
WebUI.click(findTestObject('Captured Retail CRM/Page_icon-app/a_Retail'))
...
WebUI.click(findTestObject('Object Repository/create retail/Page_icon-app/a_2019'))
...
not_run: WebUI.click(findTestObject('Page_icon-app/Page_icon-app/Page_icon-app/Page_icon-app/Page_icon-app/div_'))

not_run: WebUI.click(findTestObject('create retail/Page_icon-app/li_MRS - MRS'))

WebUI.click(findTestObject('create retail/Page_icon-app/div_'))

WebUI.click(findTestObject('Object Repository/create retail/Page_icon-app/li_M - MARRIED'))
