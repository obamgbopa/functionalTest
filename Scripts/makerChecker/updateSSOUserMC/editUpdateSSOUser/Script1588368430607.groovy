...
WebUI.click(findTestObject('disableSSOUser/Page_sso/button_Rejected_ant-switch'))
...
WebUI.click(findTestObject('approveSSOUser/approve/Page_sso/button_Edit'))

WebUI.click(findTestObject('approveSSOUser/approve/Page_sso/button_Logout Time_ant-switch'))

WebUI.click(findTestObject('approveSSOUser/approve/Page_sso/button_Update'))
