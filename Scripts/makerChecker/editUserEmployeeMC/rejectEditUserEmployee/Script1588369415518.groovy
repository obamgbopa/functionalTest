...
WebUI.click(findTestObject('disableSSOUser/Page_sso/li_Update User Employee Data'))
...
WebUI.click(findTestObject('approveSSOUser/Page_sso/button_Rejectf'))

WebUI.setText(findTestObject('approveSSOUser/Page_sso/textarea_Reason_ant-input'), 'just for test')

WebUI.click(findTestObject('approveSSOUser/Page_sso/button_Rejects'))
