...
WebUI.click(findTestObject('approveSSOUser/extras/Page_sso/button_UPDATE_table__btn ant-btn ant-btn-primary ant-btn-sm ant-btn-icon-only'))

WebUI.click(findTestObject('approveSSOUser/extras/Page_sso/button_Approveup'))
