...
WebUI.setText(findTestObject('SSOUser/ApproveSSOUser/Page_Icon Login/input_WELCOME BACK_username'), 'fiyin')

WebUI.setText(findTestObject('SSOUser/ApproveSSOUser/Page_Icon Login/input_WELCOME BACK_password'), '!Abc123')

WebUI.click(findTestObject('SSOUser/ApproveSSOUser/Page_Icon Login/button_Login'))

WebUI.click(findTestObject('SSOUser/ApproveSSOUser/Page_icon-app/a_Users'))
