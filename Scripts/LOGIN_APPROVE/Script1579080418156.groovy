...
WebUI.click(findTestObject('NEW_LOGINOR/new/Page_sso/button_CORE_app__buttonk'))

WebUI.click(findTestObject('NEW_LOGIN_APPROVEOR/Page_sso/Page_icon-app/a_Build No_aside__toggler'))
