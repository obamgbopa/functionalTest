...
WebUI.click(findTestObject('CRM_OR/CreateRetailCustomer/Retail/CancelRetailUser/button_Cancel__'))
...
if (WebUI.verifyTextPresent('Success', false, FailureHandling.OPTIONAL)) {
    ...
    WebUI.takeScreenshot(('C:\\Users\\DEVELOPER\\Katalon Studio\\LegacyCore\\functionalTest\\cancelRetailCustScreenshot' + 
        randomNum) + '.png')
