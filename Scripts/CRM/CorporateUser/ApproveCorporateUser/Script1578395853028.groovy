...
WebUI.click(findTestObject('CRM_OR/CorporateCutomer/Corporate/Approve_Corporate_Customer/button_Approve_1'))
...
if (WebUI.verifyTextPresent('Success', false, FailureHandling.OPTIONAL)) {
    ...
    WebUI.takeScreenshot(('C:\\Users\\DEVELOPER\\Katalon Studio\\LegacyCore\\functionalTest\\ApproveCorporateCustScreenshot' + 
        randomNum) + '.png')
}
