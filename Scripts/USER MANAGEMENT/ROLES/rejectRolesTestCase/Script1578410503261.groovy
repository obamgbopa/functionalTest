...
WebUI.click(findTestObject('USER_MANAGEMENT_OR/rolesOR/approveRolesOR/Page_icon-app/button_Rejection'))

WebUI.setText(findTestObject('USER_MANAGEMENT_OR/rolesOR/approveRolesOR/Page_icon-app/textarea_Reason_ant-input'), 'Just for test')

WebUI.click(findTestObject('USER_MANAGEMENT_OR/rolesOR/approveRolesOR/Page_icon-app/button_Rejecting'))
