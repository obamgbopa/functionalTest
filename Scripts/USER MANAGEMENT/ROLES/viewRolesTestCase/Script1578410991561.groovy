...
WebUI.click(findTestObject('USER_MANAGEMENT_OR/rolesOR/viewRolesOR/Page_icon-app/a_Roles'))
...
WebUI.click(findTestObject('USER_MANAGEMENT_OR/rolesOR/viewRolesOR/Page_icon-app/a_View'))
