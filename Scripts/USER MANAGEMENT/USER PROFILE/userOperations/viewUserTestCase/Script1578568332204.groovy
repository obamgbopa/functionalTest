...
WebUI.click(findTestObject('USER_MANAGEMENT_OR/userProfileOR/viewUserOR/Page_icon-app/a_User Profile'))

WebUI.click(findTestObject('USER_MANAGEMENT_OR/userProfileOR/viewUserOR/Page_icon-app/button_Pending Authorizations_ant-btn ant-b_3a46fa'))
...
WebUI.click(findTestObject('USER_MANAGEMENT_OR/userProfileOR/viewUserOR/Page_icon-app/a_View'))
