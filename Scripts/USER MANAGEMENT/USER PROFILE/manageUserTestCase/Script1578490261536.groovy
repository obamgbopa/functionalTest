...
WebUI.click(findTestObject('USER_MANAGEMENT_OR/userProfileOR/manageUserOR/spy/Page_icon-app/li_500 - MANAGER'))
...
WebUI.click(findTestObject('USER_MANAGEMENT_OR/userProfileOR/spy/Page_icon-app/input_Reset_ant-checkbox-input'))

WebUI.delay(2)

WebUI.click(findTestObject('USER_MANAGEMENT_OR/userProfileOR/spy/Page_icon-app/button_Confirm Selected'))
