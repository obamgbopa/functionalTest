...
WebUI.click(findTestObject('SI/ApproveCopiedSI/li_Stop Standing Instruction'))

WebUI.click(findTestObject('SI/ApproveEditedSI/button_Search Request'))

WebUI.click(findTestObject('SI/ApproveCopiedSI/button_OTHERS_table__btn ant-btn ant-btn-primary'))

WebUI.delay(3)

WebUI.click(findTestObject('SI/ApproveCopiedSI/div_Transaction Details'))

WebUI.delay(3)

WebUI.click(findTestObject('SI/ApproveCopiedSI/button_Approve'))
