...
WebUI.click(findTestObject('SI/StopSI/button_ACTIVE_table__btn'))

WebUI.delay(2)

WebUI.click(findTestObject('SI/StopSI/a_ Stop'))

WebUI.click(findTestObject('SI/StopSI/button_Next1'))

WebUI.delay(3)

WebUI.click(findTestObject('SI/StopSI/button_Next2'))

WebUI.click(findTestObject('SI/StopSI/button_Stop Standing Instruction'))

WebUI.click(findTestObject('SI/StopSI/button_Yes'))
