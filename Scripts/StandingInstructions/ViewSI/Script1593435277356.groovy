...
WebUI.click(findTestObject('SI/ViewSI/a_ View'))

WebUI.delay(5)

WebUI.click(findTestObject('SI/ViewSI/div_Transaction Details'))

WebUI.delay(5)

WebUI.click(findTestObject('SI/ViewSI/TransactionDetailssvg'))

WebUI.delay(4)

WebUI.click(findTestObject('SI/ViewSI/li_2'))

WebUI.delay(4)

WebUI.click(findTestObject('SI/ViewSI/li_1'))

WebUI.click(findTestObject('SI/ViewSI/Cancelsvg'))

WebUI.click(findTestObject('SI/ViewSI/div_General Details'))
