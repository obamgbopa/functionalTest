...
WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/li_BUSINESS_GROUP'))

WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/input_Business Group_ant-input'))

WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/bussGrpSearchsvg'))

WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/button_Search_busgrp'))

WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/button_Select_busgrp'))
