...
WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/li_ROLE'))

WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/input_Role_ant-input'))

WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/roleSearchsvg'))

WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/button_Search_Role'))

WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/button_Select_Role'))
