...
WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/li_GLOBAL'))
...
not_run: WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/productTYPEcodeee'))

not_run: WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/li_SAVINGSssssss'))

not_run: WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/button_Search_prodTo'))

not_run: WebUI.delay(1)

not_run: WebUI.click(findTestObject('EABRebuild/EOD_ Batch Account Bal Rebuild/button_Select_prodTo'))
