...
WebUI.click(findTestObject('EABRebuild/EOD_Account_Balance_Rebuild/Page_icon-app/li_BUSINESS_GROUP'))

WebUI.click(findTestObject('EABRebuild/EOD_Account_Balance_Rebuild/Page_icon-app/input_Business Group_ant-input'))

WebUI.click(findTestObject('EABRebuild/EOD_Account_Balance_Rebuild/Page_icon-app/searchBusGrp'))

WebUI.click(findTestObject('EABRebuild/EOD_Account_Balance_Rebuild/Page_icon-app/button_Search_busGrp'))

WebUI.click(findTestObject('EABRebuild/EOD_Account_Balance_Rebuild/Page_icon-app/button_Select_busGrp'))
