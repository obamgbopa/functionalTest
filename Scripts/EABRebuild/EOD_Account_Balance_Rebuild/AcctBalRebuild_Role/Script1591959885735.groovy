...
WebUI.click(findTestObject('EABRebuild/EOD_Account_Balance_Rebuild/Page_icon-app/li_ROLE'))

WebUI.click(findTestObject('EABRebuild/EOD_Account_Balance_Rebuild/Page_icon-app/input_Role_ant-input'))

WebUI.click(findTestObject('EABRebuild/EOD_Account_Balance_Rebuild/Page_icon-app/search_RoleSVG'))

WebUI.click(findTestObject('EABRebuild/EOD_Account_Balance_Rebuild/Page_icon-app/button_Search_role'))

WebUI.click(findTestObject('EABRebuild/EOD_Account_Balance_Rebuild/Page_icon-app/button_Select_role'))
