...
WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/li_USER'))

WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/input_User_ant-input'))

WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/searchUsersvg'))

WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/button_Search_User'))

WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/button_Select_user'))
