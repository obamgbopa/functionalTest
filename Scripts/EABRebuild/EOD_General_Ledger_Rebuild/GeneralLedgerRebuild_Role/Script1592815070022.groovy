...
WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/li_ROLE'))

WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/input_Role_ant-input'))

WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/searRolesvg'))

WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/button_Search_Role'))

WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/button_Select_Role'))
