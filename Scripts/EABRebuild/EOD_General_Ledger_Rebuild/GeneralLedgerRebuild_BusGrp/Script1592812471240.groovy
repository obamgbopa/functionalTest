...
WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/li_BUSINESS_GROUP'))

WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/input_Business Group_ant-input'))

WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/searchBusGrpsvg'))

WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/button_Search_BusGrp'))

WebUI.click(findTestObject('EABRebuild/EOD_General_Ledger_Rebuild/button_Select_BusGrp'))
