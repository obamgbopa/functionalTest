...
WebUI.click(findTestObject('BANK_SETUP_OR/NextNumberOR/deleteNextNumberOR/Page_icon-app/a_Next Number'))

not_run: WebUI.setText(findTestObject('BANK_SETUP_OR/NextNumberOR/deleteNextNumberOR/Page_icon-app/input_Add Next Number_ant-input'), 
    'xyz')
...
WebUI.click(findTestObject('BANK_SETUP_OR/NextNumberOR/deleteNextNumberOR/Page_icon-app/a_ Delete'))
