...
WebUI.click(findTestObject('BANK_SETUP_OR/NextNumberOR/viewNextNumber/Page_icon-app/a_Next Number'))
...
not_run: WebUI.click(findTestObject('BANK_SETUP_OR/NextNumberOR/viewNextNumber/Page_icon-app/button_Add Next Number_ant-btn ant-btn-prim_c0fd96'))

not_run: WebUI.click(findTestObject('BANK_SETUP_OR/NextNumberOR/viewNextNumber/Page_icon-app/button_Add Next Number_ant-btn ant-btn-prim_c0fd96'))

WebUI.click(findTestObject('BANK_SETUP_OR/NextNumberOR/viewNextNumber/Page_icon-app/a_ View'))
