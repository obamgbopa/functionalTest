...
WebUI.setText(findTestObject('BANK_SETUP_OR/exceptionAndErrorOR/spy/Page_icon-app/input_Code_ant-input'), CustomKeywords.'Keywords.randomData.TestDataGenerator.set_RandomNumber'(3))

WebUI.setText(findTestObject('BANK_SETUP_OR/exceptionAndErrorOR/spy/Page_icon-app/input_Code Description_ant-input'), CustomKeywords.'Keywords.randomData.TestDataGenerator.getRandomHeading'(3))
...
WebUI.setText(findTestObject('BANK_SETUP_OR/exceptionAndErrorOR/spy/Page_icon-app/input_Message_ant-input'), CustomKeywords.'Keywords.randomData.TestDataGenerator.getRandomHeading'(3))
