...
WebUI.setText(findTestObject('BANK_SETUP_OR/globalCodesOR/addCodeType/input/Page_icon-app/input_Code Type_ant-input'), CustomKeywords.'Keywords.randomData.TestDataGenerator.getRandomName'(
        1, 4))

WebUI.setText(findTestObject('BANK_SETUP_OR/globalCodesOR/addCodeType/input1/Page_icon-app/input_Code Remark_ant-input'), 
    CustomKeywords.'Keywords.randomData.TestDataGenerator.getRandomName'(1, 2))
