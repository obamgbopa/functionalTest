...
WebUI.click(findTestObject('BANK_SETUP_OR/subSegmentOR/spy/Page_icon-app/li_DEFAULT - null'))

WebUI.click(findTestObject('BANK_SETUP_OR/subSegmentOR/spy/Page_icon-app/button_Submit'))
