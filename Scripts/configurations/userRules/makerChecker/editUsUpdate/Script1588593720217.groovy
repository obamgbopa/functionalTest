...
WebUI.click(findTestObject('configurations/MC/Page_sso/button_EditUs'))

WebUI.click(findTestObject('configurations/MC/Page_sso/button_Enable Two Factor Authentication_ant-switch'))

WebUI.click(findTestObject('configurations/MC/Page_sso/button_SubmitUs'))
