...
WebUI.click(findTestObject('configurations/MC/new/Page_sso/button_RejectU'))

WebUI.setText(findTestObject('configurations/MC/new/Page_sso/textarea_Reason_ant-inputU'), 'for test')

WebUI.click(findTestObject('configurations/MC/new/Page_sso/button_Reject_U'))
