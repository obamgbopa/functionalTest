...
WebUI.click(findTestObject('Object Repository/LOGIN_MC/Page_icon-app/span_Office Account'))

WebUI.click(findTestObject('Object Repository/LOGIN_MC/Page_icon-app/a_Demand Draft'))

WebUI.click(findTestObject('Object Repository/LOGIN_MC/Page_icon-app/div_Pending Authorizations'))

WebUI.click(findTestObject('Object Repository/LOGIN_MC/Page_icon-app/button__ant-btn ant-btn-primary'))
