...
WebUI.click(findTestObject('DD_multiples/new_in/Page_icon-app/a_Build No_aside__toggler'))

WebUI.click(findTestObject('MakerChecker/createMC/Page_icon-app/span_Products'))

WebUI.click(findTestObject('MakerChecker/createMC/Page_icon-app/a_Demand Draft'))
