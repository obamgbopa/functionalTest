...
WebUI.click(findTestObject('MakerChecker/Page_icon-app/button_INSERT_table__btn ant-btn ant-btn-primary'))

WebUI.click(findTestObject('MakerChecker/update/Page_icon-app/button_Edit'))

WebUI.click(findTestObject('MakerChecker/update/Page_icon-app/button_Self Reconciling_ant-switch ant-switch-checked'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('MakerChecker/update/Page_icon-app/button_Update Product'))

WebUI.click(findTestObject('MakerChecker/update/Page_icon-app/button_Yes1'))
