...
WebUI.click(findTestObject('MakerChecker/Page_icon-app/Page_icon-app/button_Edit'))

WebUI.click(findTestObject('MakerChecker/Page_icon-app/Page_icon-app/button_Self Reconciling_ant-switch ant-switch-checked'))

WebUI.click(findTestObject('MakerChecker/Page_icon-app/Page_icon-app/button_Update Product'))

WebUI.click(findTestObject('MakerChecker/Page_icon-app/Page_icon-app/button_Yes'))
