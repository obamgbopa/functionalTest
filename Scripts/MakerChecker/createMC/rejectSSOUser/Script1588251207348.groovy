...
WebUI.click(findTestObject('approveSSOUser/new/Page_sso/button_Rejectk'))

WebUI.setText(findTestObject('approveSSOUser/extras/Page_sso/textarea_Reason_ant-input'), 'just for test')

WebUI.click(findTestObject('approveSSOUser/Page_sso/button_Rejectb'))
