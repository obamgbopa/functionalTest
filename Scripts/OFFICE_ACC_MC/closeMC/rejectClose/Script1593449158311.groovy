...
WebUI.click(findTestObject('MAKERCHECKER/Page_icon-app/li_Close office account'))
...
WebUI.click(findTestObject('MAKERCHECKER/Page_icon-app/button_RejectClose'))

WebUI.setText(findTestObject('MAKERCHECKER/Page_icon-app/textarea_Reason_ant-inputClose'), 'for test')

WebUI.click(findTestObject('MAKERCHECKER/Page_icon-app/button_RejectClose2'))
