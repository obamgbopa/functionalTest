...
WebUI.click(findTestObject('MAKERCHECKER/Page_icon-app/button_RejectGLT'))

WebUI.setText(findTestObject('MAKERCHECKER/Page_icon-app/textarea_Reason_ant-inputGLT'), 'for test')

WebUI.click(findTestObject('MAKERCHECKER/Page_icon-app/button_RejectGLT (1)'))
