...
WebUI.click(findTestObject('MAKERCHECKER/Page_icon-app/li_Unfreeze office account'))
...
WebUI.click(findTestObject('MAKERCHECKER/Page_icon-app/button_RejectUnfreeze'))

WebUI.setText(findTestObject('MAKERCHECKER/Page_icon-app/textarea_Reason_ant-inputUnfreeze'), 'for test')

WebUI.click(findTestObject('MAKERCHECKER/Page_icon-app/button_RejectUnfreeze2'))
