...
WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/spy/Page_Operative Account  ICON APP/button_Reject1'))

WebUI.setText(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/spy/Page_Operative Account  ICON APP/textarea_Reason_ant-input'), 
    'Just for Test')

WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/spy/Page_Operative Account  ICON APP/button_Reject2'))
