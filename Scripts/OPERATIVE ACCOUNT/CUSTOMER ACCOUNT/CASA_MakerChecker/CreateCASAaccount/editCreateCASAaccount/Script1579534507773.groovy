...
WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/spy/Page_Operative Account  ICON APP/button_Edit'))

WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/spy/edit/Page_Operative Account  ICON APP/div_JOINT'))

WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/spy/edit/Page_Operative Account  ICON APP/li_SINGLE'))

WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/spy/edit/Page_Operative Account  ICON APP/button_Create Account'))
