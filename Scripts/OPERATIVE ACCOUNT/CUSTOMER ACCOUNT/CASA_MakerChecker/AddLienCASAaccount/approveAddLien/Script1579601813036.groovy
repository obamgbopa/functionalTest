...
WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/addLienAndFreeze/Page_Operative Account  ICON APP/li_Add Lien'))
...
WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/addLienAndFreeze/Page_Operative Account  ICON APP/button_Approve'))
