...
WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/editCASAaccount/Page_Operative Account  ICON APP/li_Edit current and savings account'))
...
WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/editCASAaccount/spy/Page_Operative Account  ICON APP/button_Edit'))

WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/editCASAaccount/spy/Page_Operative Account  ICON APP/div_'))

not_run: WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/spy/edit/Page_Operative Account  ICON APP/div_JOINT'))

WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/editCASAaccount/spy/Page_Operative Account  ICON APP/li_SINGLE'))

WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/editCASAaccount/spy/Page_Operative Account  ICON APP/button_Create Account'))
