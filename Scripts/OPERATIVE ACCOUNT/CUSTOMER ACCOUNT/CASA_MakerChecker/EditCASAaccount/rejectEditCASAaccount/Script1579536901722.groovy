...
WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/editCASAaccount/Page_Operative Account  ICON APP/button_Rejectal'))

WebUI.setText(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/editCASAaccount/Page_Operative Account  ICON APP/textarea_Reason_ant-input'), 
    'Just for test')

WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CASA_Maker_Checker/Page_Operative Account  ICON APP/button_Rejection'))
