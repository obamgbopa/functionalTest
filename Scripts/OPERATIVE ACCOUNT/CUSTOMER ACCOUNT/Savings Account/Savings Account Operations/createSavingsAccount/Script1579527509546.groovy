...
WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/SAVINGS ACCOUNT/createSavingsAccount/Page_Operative Account  ICON APP/li_SAVINGS'))
...
WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/SAVINGS ACCOUNT/createSavingsAccount/Page_Operative Account  ICON APP/li_AGENCY BANKING - 45993'))
...
WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/SAVINGS ACCOUNT/createSavingsAccount/spy/Page_Operative Account  ICON APP/li_NGN'))

WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/SAVINGS ACCOUNT/createSavingsAccount/spy/Page_Operative Account  ICON APP/button_Open Account'))
...
WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/SAVINGS ACCOUNT/createSavingsAccount/spy/Page_Operative Account  ICON APP/button_Search'))

WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/SAVINGS ACCOUNT/createSavingsAccount/spy/Page_Operative Account  ICON APP/button_Select'))

WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/SAVINGS ACCOUNT/createSavingsAccount/spy/Page_Operative Account  ICON APP/button_Add Party'))
...
WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/SAVINGS ACCOUNT/createSavingsAccount/spy/Page_Operative Account  ICON APP/button_Add Mandate'))
