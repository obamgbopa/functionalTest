...
not_run: WebUI.click(findTestObject('Object Repository/OPERATIVE_ACCOUNT_OR/CURRENT ACCOUNT/viewCurrentAccount/Page_Operative Account  ICON APP/div_Product Type            SAVINGS'))

not_run: WebUI.click(findTestObject('Object Repository/OPERATIVE_ACCOUNT_OR/CURRENT ACCOUNT/viewCurrentAccount/Page_Operative Account  ICON APP/li_CURRENT'))
...
WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/SAVINGS ACCOUNT/Page_Operative Account  ICON APP/a_Close'))

WebUI.click(findTestObject('OPERATIVE_ACCOUNT_OR/CURRENT ACCOUNT/closeCurrentAccount/Page_Operative Account  ICON APP/button_Yes Delete'))
