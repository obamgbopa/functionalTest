...
WebUI.click(findTestObject('OFFICE_OPS/Page_icon-app/button_Transfer from Other Branches_ant-switch'))

WebUI.click(findTestObject('OFFICE_OPS/Page_icon-app/button_System Only Transaction_ant-switch'))

WebUI.click(findTestObject('OFFICE_OPS/Page_icon-app/button_Update Account'))

WebUI.click(findTestObject('OFFICE_OPS/Page_icon-app/button_Yes4'))
