...
WebUI.setText(findTestObject('Object Repository/SSOContextSearch/Page_sso/input_Username_ant-input'), 'simby')
...
WebUI.click(findTestObject('deleteSSOUser/Page_sso/a_Reset Password'))

WebUI.click(findTestObject('deleteSSOUser/Page_sso/button_OK_r'))
